                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('name') }}" required type="text" name="name" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('address') }}" class="form-control" placeholder="" name="address" type="text" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('email') }}" type="email" name="email" class="form-control" placeholder="">
                                    </div>
                                </div>
